    ...
    private static Object getFieldValue(Object obj, String fieldName) {
        ...
        while (clazz != null) {
            try {
                ...
                throw new RuntimeException("Cannot access filed" + fieldName, e);
            }
        }
        throw new RuntimeException("Field not found:" + fieldName + "in class" + obj.getClass().getSimpleName());
    }
